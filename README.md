...
> 📸 **[사진: 학습 폴더, Python 실행명, 대표 모델 입력 영역]**
...
> 📸 **[사진: Loss 그래프 — 파란선(loss)과 주황선(val_loss)]**
...
> 📸 **[사진: 이미지 위에 파란선/초록선이 오버레이된 예측 결과 화면]**
