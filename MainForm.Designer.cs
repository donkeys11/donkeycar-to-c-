...
namespace DonkeycarManager
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
            ...
            tabViewer.Margin = new Padding(5);
            tabViewer.Name = "tabViewer";
            tabViewer.Padding = new Padding(5);
            ...
            btnOpenDataFolder.Margin = new Padding(5);
            ...
            btnAutoPlay.Margin = new Padding(5);
            ...
            lstFrames.Margin = new Padding(5);
            ...
            tabCleaner.Margin = new Padding(5);
            tabCleaner.Name = "tabCleaner";
            tabCleaner.Padding = new Padding(5);
            ...
            grpFilters.Margin = new Padding(5);
            grpFilters.Name = "grpFilters";
            grpFilters.Padding = new Padding(5);
            ...
            chkThrottlePositive.Margin = new Padding(5);
            ...
            chkExcludeZeroAngle.Margin = new Padding(5);
            ...
            chkStopDataOnly.Margin = new Padding(5);
            ...
            btnClearFilter.Margin = new Padding(5);
            ...
            btnDeleteFrame.Margin = new Padding(5);
            ...
            grpCleanerRangeEditor.Location = new Point(1167, 144);
            grpCleanerRangeEditor.Margin = new Padding(5);
            grpCleanerRangeEditor.Name = "grpCleanerRangeEditor";
            grpCleanerRangeEditor.Padding = new Padding(5);
            grpCleanerRangeEditor.Size = new Size(964, 272);
            grpCleanerRangeEditor.TabIndex = 5;
            ...
            lblCleanerRangeHint.Location = new Point(498, 45);
            lblCleanerRangeHint.Margin = new Padding(5, 0, 5, 0);
            lblCleanerRangeHint.Name = "lblCleanerRangeHint";
            lblCleanerRangeHint.Size = new Size(449, 37);
            lblCleanerRangeHint.TabIndex = 1;
            lblCleanerRangeHint.Text = "타임라인에서 드래그하여 구간 선택";
            // 
            // pnlCleanerTimeline
            // 
            ...
            pnlCleanerTimeline.Location = new Point(23, 93);
            pnlCleanerTimeline.Margin = new Padding(5);
            pnlCleanerTimeline.Name = "pnlCleanerTimeline";
            pnlCleanerTimeline.Size = new Size(909, 71);
            ...
            btnDeleteRange.Location = new Point(23, 184);
            btnDeleteRange.Margin = new Padding(5);
            btnDeleteRange.Name = "btnDeleteRange";
            btnDeleteRange.Size = new Size(187, 61);
            btnDeleteRange.TabIndex = 3;
            ...
            btnPlayRange.Location = new Point(233, 184);
            btnPlayRange.Margin = new Padding(5);
            btnPlayRange.Name = "btnPlayRange";
            btnPlayRange.Size = new Size(187, 61);
            btnPlayRange.TabIndex = 4;
            btnPlayRange.Text = "구간 재생";
            btnPlayRange.UseVisualStyleBackColor = false;
            // 
            // btnClearRange
            // 
            btnClearRange.Location = new Point(443, 184);
            btnClearRange.Margin = new Padding(5);
            btnClearRange.Name = "btnClearRange";
            btnClearRange.Size = new Size(187, 61);
            btnClearRange.TabIndex = 5;
            ...
            lstCleanerFrames.Margin = new Padding(5);
            ...
            picCleanerPreview.Margin = new Padding(5);
            ...
            tabTrainer.Margin = new Padding(5);
            tabTrainer.Name = "tabTrainer";
            tabTrainer.Padding = new Padding(5);
            ...
            txtMycarPath.Margin = new Padding(5);
            ...
            btnBrowseMycar.Margin = new Padding(5);
            ...
            txtPythonExe.Margin = new Padding(5);
            ...
            txtTrainArgs.Margin = new Padding(5);
            ...
            btnStopTrain.Margin = new Padding(5);
            ...
            tabPilotTest.Margin = new Padding(5);
            tabPilotTest.Name = "tabPilotTest";
            tabPilotTest.Padding = new Padding(5);
            ...
            txtModelPath.Margin = new Padding(5);
            ...
            btnBrowseModel.Margin = new Padding(5);
            ...
            btnRunPilotTest.Margin = new Padding(5);
            ...
            // btnUseViewerFrame
            // 
            btnUseViewerFrame.Location = new Point(607, 232);
            btnUseViewerFrame.Margin = new Padding(5);
            ...
            picPilotTest.Margin = new Padding(5);
            picPilotTest.Name = "picPilotTest";
            picPilotTest.Size = new Size(1010, 543);
            picPilotTest.SizeMode = PictureBoxSizeMode.Zoom;
            picPilotTest.TabIndex = 6;
            picPilotTest.TabStop = false;
            // 
            // lblPilotImageList
            // 
            lblPilotImageList.AutoSize = true;
            lblPilotImageList.Font = new Font("맑은 고딕", 10F, FontStyle.Bold);
            lblPilotImageList.Location = new Point(47, 912);
            lblPilotImageList.Margin = new Padding(5, 0, 5, 0);
            lblPilotImageList.Name = "lblPilotImageList";
            lblPilotImageList.Size = new Size(251, 37);
            lblPilotImageList.TabIndex = 7;
            lblPilotImageList.Text = "테스트 이미지 선택";
            // 
            // lstPilotFrames
            // 
            lstPilotFrames.Anchor = AnchorStyles.Bottom | AnchorStyles.Left;
            lstPilotFrames.Font = new Font("Consolas", 9F);
            lstPilotFrames.HorizontalScrollbar = true;
            lstPilotFrames.Location = new Point(1429, 352);
            lstPilotFrames.Margin = new Padding(5);
            lstPilotFrames.Name = "lstPilotFrames";
            lstPilotFrames.Size = new Size(741, 480);
            lstPilotFrames.TabIndex = 8;
            // 
            // lblActualAngle
            // 
